...
{
    [EditorTools.AberrationDescription("Bakery lightmap loading utility.", "Jacob Cooper", "14/11/2021")]
    public class Lightmaps
    {
        ...
        static Texture2D GetEmptyDirectionTex(LightmapsStorage storage)
        {

            return storage.emptyDirectionTex;
        }

        public static void RefreshScene(Scene scene, LightmapsStorage storage = null, bool updateNonBaked = false)
        {
            var sceneCount = SceneManager.sceneCount;
            ...
            if (storage == null)
            {
                ...
                storage = go.GetComponent<LightmapsStorage>();
                if (storage == null)
                {
        ...
        public static void UnloadScene(LightmapsStorage storage)
        {
        ...
        public static void RefreshScene2(Scene scene, LightmapsStorage storage)
        {
            Renderer r;
            int id;
            for (int i = 0; i < storage.bakedRenderers.Count; i++)
